  ...
  const documents = [
    {
      ...
      icon: Award,
      url: siteSettings?.document_management_system_url || managementSystemCertificate,
    },
    {
      id: "free-sale",
      ...
      icon: FileCheck,
      url: siteSettings?.document_free_sale_url || freeSaleCertificate,
    },
    {
      id: "certificate-of-competence",
      title: "Certificate of Competence",
      description: "Professional qualification verification",
      icon: FileText,
      url: siteSettings?.document_certificate_of_competence_url || certificateOfCompetence,
    },
  ]
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <h3 className="mb-1 font-medium text-foreground">{document.title}</h3>
