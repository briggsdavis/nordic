  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="https://images.unsplash.com/photo-1574781330855-d0db8cc6a79c?auto=format&fit=crop&w=2000&q=80"
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="border-card/40 text-card hover:bg-card/10 px-8 py-6 text-sm tracking-wide uppercase font-medium"
            >
              B2B Inquiries
            </Button>
          </div>
